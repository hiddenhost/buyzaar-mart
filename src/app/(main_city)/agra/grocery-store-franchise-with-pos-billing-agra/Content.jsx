...
const localBusinessSchema = {
  ...
  description:
    "The Buyzaar Mart offers a modern grocery store franchise in Agra with POS billing, MiniMart, SuperMart, and HyperMart formats, FOCM support, inventory management, and complete franchise assistance.",
    ...
    itemListElement: [
      {
        ...
        name: "MiniMart",
        description:
          "Entry-level grocery franchise format designed for residential colonies, apartment complexes, and lower-footfall neighbourhood locations in Agra.",
      },
      {
        "@type": "Offer",
        name: "SuperMart",
        description:
          "Mid-tier full-service supermarket format suited for busier residential and semi-commercial areas in Agra.",
      },
      {
        "@type": "Offer",
        name: "HyperMart",
        description:
          "Large-format grocery franchise suited for high-footfall commercial zones and one-stop shopping destinations in Agra.",
      },
    ],
  },
};
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Investment depends on the store format. MiniMart needs the lowest entry investment, while SuperMart and HyperMart require more. Exact figures vary by locality and space size.",
      },
    },
    {
      "@type": "Question",
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Yes. The POS billing setup is included in the standard store package and comes pre-configured with barcode scanning, automated stock updates, and GST-compliant invoicing.",
      },
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Yes. The system automatically generates GST-ready invoices, removing the need for manual bill calculation or separate accounting tools.",
      },
    },
  ],
};
      ...
      <div className="flex flex-col lg:flex-row">
        <div className="order-1 flex-1 px-4 py-0 sm:px-8 md:px-16 lg:order-1">
          <div className="max-w-4xl space-y-4 font-serif font-medium leading-relaxed text-gray-700">
            ...
            <h2 className="text-xl font-medium text-gray-900 sm:text-2xl">
              POS Billing and Why It Matters
            </h2>
            ...
            <ul className="list-disc space-y-2 pl-6">
              ...
              <li>Accurate stock tracking: Every item sold is deducted from inventory instantly, so you always know what needs reordering and what is overstocked.</li>
            ...
            <p>
              The Buyzaar Mart offers multiple store formats so you can choose one that matches your budget, available space, and the locality you are targeting in Agra.
            </p>

            <h3 className="font-medium text-gray-900">MiniMart</h3>
            <p>
              MiniMart is the entry-level format, typically 600 to 1000 sq. ft., ideal for residential colonies, apartment complexes, and lower-footfall lanes. This format covers essential grocery and FMCG categories and is the most accessible option for first-time investors or those working with a smaller budget.
            </p>

            <h3 className="font-medium text-gray-900">SuperMart</h3>
            <p>
              SuperMart is a mid-tier, full-service neighbourhood supermarket format, usually between 1,001 to 3,000 sq. ft. It carries a broader product range across grocery, dairy, personal care, beverages, snacks, household essentials, and more — suited for busier residential and semi-commercial areas of Agra such as Kamla Nagar, Sikandra, and Shahganj.
            </p>
            ...
            <p>
              If you are ready to explore what a Buyzaar Mart franchise looks like for your preferred location in Agra, reach out to the franchise team to discuss store formats, investment options, and next steps.
            </p>
            ...
            <div className="mt-4 space-y-4">
              <div>
                ...
                <p className="mt-2">
                  Investment depends on the store format. MiniMart needs the lowest entry investment, while SuperMart and HyperMart require more. Exact figures vary by locality and space size.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="mt-2">
                  Yes. The POS billing setup is included in the standard store package and comes pre-configured with barcode scanning, automated stock updates, and GST-compliant invoicing.
                </p>
              </div>
