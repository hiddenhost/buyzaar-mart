            ...
            {paginatedBlogs.map((post) => (
              ...
              >
                ...
                <div className="p-3 md:p-4">
                  ...
                  {/* Title */}
                  <h3 className="text-sm md:text-base font-bold mb-2 line-clamp-2 text-gray-900 group-hover:text-[#b00000] transition-colors duration-300">
                    {post.title}
                  </h3>
