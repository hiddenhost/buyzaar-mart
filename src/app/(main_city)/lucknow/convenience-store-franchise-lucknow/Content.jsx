        ...
        <div className="order-1 flex-1 px-4 py-0 sm:px-8 md:px-16 lg:order-1">
          <div className="max-w-4xl space-y-4 font-serif font-medium leading-relaxed text-gray-700">
              ...
              <table className="mt-4 min-w-full border border-gray-200 text-left text-sm">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="border border-gray-200 px-4 py-3">₹ 12,00,000</td>
                  </tr>
                  <tr>
                    <td className="border border-gray-200 px-4 py-3">
                  ...
                  <tr>
                    ...
                    <td className="border border-gray-200 px-4 py-3">₹ 13,20,000</td>
                  </tr>
                  <tr>
                    <td className="border border-gray-200 px-4 py-3">
                      Miscellaneous (signage, small fixtures, launch costs)
                    </td>
                    <td className="border border-gray-200 px-4 py-3">₹ 1,94,139</td>
                  </tr>
            ...
            <div className="overflow-x-auto">
              <table className="mt-4 min-w-full border border-gray-200 text-left text-sm">
                ...
                <tbody>
                  ...
                  <tr>
                    <td className="border border-gray-200 px-4 py-3">Interior Setup Cost</td>
                  ...
                  <tr>
                    <td className="border border-gray-200 px-4 py-3">
                      Miscellaneous (signage, extra fixtures, launch campaigns)
                    </td>
            ...
            <div className="space-y-3">
              <p>
                <span className="font-semibold text-gray-900">Step 1 &mdash; Submit an Inquiry:</span>{" "}
                Visit{" "}
                <a
              ...
              <p>
                <span className="font-semibold text-gray-900">Step 2 &mdash; Location Finalization:</span>{" "}
