            ...
            <div className="flex flex-col lg:flex-row">
                <div className="order-1 flex-1 px-4 py-0 sm:px-8 md:px-16 lg:order-1">
                    <div className="max-w-4xl space-y-4 font-serif font-medium leading-relaxed text-gray-700">
                        ...
                        <p>
                            Noida Extension (also known as Greater Noida West) has emerged as one of the
                            fastest-growing residential and commercial hubs in the Delhi-NCR region.
                            Rapid urban development, a growing population, and the continuous launch of
                            new residential societies have significantly increased the demand for
                            organised grocery stores that offer convenience, quality products, and a
                            reliable shopping experience. As more families move into the area, the need
                            for modern neighbourhood retail continues to grow, creating attractive
                            opportunities for retail entrepreneurs.

                            Buyzaar Mart brings a structured grocery franchise opportunity for
                            entrepreneurs, investors, and existing business owners looking to establish
                            a branded retail business in this expanding market. With a proven business
                            model, operational support, supply chain assistance, and a recognised retail
                            format, franchise partners can enter the organised grocery sector with
                            greater confidence.
                        </p>
                        ...
                        <ul className="list-disc space-y-3 pl-6 text-gray-700">
                            <li>
                                Buyzaar Mart is an organised retail chain designed to bring a modern
                                supermarket shopping experience to rapidly growing residential
                                neighbourhoods.
                            </li>

                            <li>
                                The stores offer a wide range of groceries, daily essentials, packaged
                                foods, personal care products, household supplies, and lifestyle items
                                under one roof for customer convenience.
                            </li>

                            <li>
                                Buyzaar Mart follows a structured retail model with standardized store
                                layouts, inventory management systems, billing processes, and customer
                                service protocols to ensure a consistent shopping experience.
                            </li>

                            <li>
                                The franchise model is suitable for both first-time entrepreneurs seeking
                                a guided business opportunity and experienced retail investors looking to
                                expand their business portfolio.
                            </li>

                            <li>
                                The brand emphasizes quality products, competitive pricing, efficient
                                operations, and a clean shopping environment to encourage repeat customers
                                and long-term loyalty.
                            </li>

                            <li>
                                Buyzaar Mart positions itself as a trusted neighbourhood supermarket,
                                combining the convenience of local kirana stores with the professionalism
                                and product variety of organised retail.
                            </li>
                        </ul>
                        <h2 className="text-xl font-medium text-gray-900 sm:text-2xl">
