...
const Brands = () => {
  ...
  const brands = [
    ...
    { id: 45, name: "Panzani", logo: "/brands/panzani.png", alt: "Panzan Logo" },
   
    { id: 47, name: "Parle Agro", logo: "/brands/parleagro.png", alt: "Parle Agro Logo" },
    { id: 48, name: "Patanjali", logo: "/brands/patanjali.png", alt: "Patnanjali Logo" },
    { id: 49, name: "Rdfoods", logo: "/brands/rdfoods.jpeg", alt: "Refoods Logo" },
    { id: 50, name: "Reckit", logo: "/brands/reckitt.png", alt: "Reckit Logo" },
