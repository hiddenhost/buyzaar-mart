...
const localBusinessSchema = {
  ...
  "@type": "LocalBusiness",
  name: "How to Start a Grocery Store in Moradabad | The Buyzaar Mart",
  description:
  ...
  url: "https://www.thebuyzaarmart.com/moradabad/how-to-start-a-grocery-store-in-moradabad",
        ...
        <div className="order-1 flex-1 px-4 py-0 sm:px-8 md:px-16 lg:order-1">
          <div className="max-w-4xl space-y-4 font-serif font-medium leading-relaxed text-gray-700">
            <h1 className="mt-8 text-2xl font-medium text-gray-900 sm:text-3xl">
              How to Start a Grocery Store in Moradabad – Complete Step-by-Step Guide by The Buyzaar Mart
            </h1>
            ...
            <p>
              Choosing between the two depends on how directly involved you want to be in daily operations versus a more investment-style approach.
            </p>
          ...
          <CityInternalLinks
            city="moradabad"
            currentSlug="/moradabad/how-to-start-a-grocery-store-in-moradabad"
          />
        </div>
