...
export const metadata = {
  ...
  keywords: [
    ...
    "Buyzaar Mart franchise contact Gurugram",
    "Buyzaar Mart contact Gurugram",
    "Buyzaar Mart Gurugram phone number",
    "Buyzaar Mart Gurugram enquiry",
    "Buyzaar Mart franchise enquiry Gurugram",
    "Buyzaar Mart franchise enquiry in Gurugram",
    "Buyzaar Mart franchise Gurugram",
    "The Buyzaar Mart Gurugram",
    "grocery franchise contact Gurugram",
    "supermarket franchise contact Gurugram",
    "retail franchise contact Gurugram",
    ...
    "grocery business enquiry Gurugram",
    "franchise business contact Gurugram",
    "retail business enquiry Gurugram",
    "grocery franchise enquiry Gurugram",
    "supermarket franchise enquiry Gurugram",
    "franchise consultation Gurugram",
    "franchise advisor Gurugram",
    "grocery store investment Gurugram",
    "franchise application Gurugram",
    "grocery business opportunity Gurugram",
    "retail franchise opportunity Gurugram",
