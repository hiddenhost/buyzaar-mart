      ...
      <div className="flex flex-col lg:flex-row">
        <div className="order-1 flex-1 px-4 py-0 sm:px-8 md:px-16 lg:order-1">
          <div className="max-w-4xl space-y-4 font-serif font-medium leading-relaxed text-gray-700">
            ...
            <p>
              In the bustling National Capital Region (NCR) of India &mdash;
              encompassing Delhi, Gurgaon (Gurugram), Ghaziabad, Noida, Greater
              Noida, Faridabad, and surrounding areas &mdash; daily needs retail
            ...
            <h3 className="font-medium text-gray-900">
              1. Mini Mart (600&ndash;1000 sq ft)
            </h3>
            <ul className="ml-4 list-inside list-disc space-y-2">
              <li>
            ...
            <h3 className="font-medium text-gray-900">
              2. Super Mart (1001&ndash;3000 sq ft)
            </h3>
            <ul className="ml-4 list-inside list-disc space-y-2">
              <li>
              ...
              <li>
                ...
                Expressway, Palam Vihar, or Sector 82&ndash;102 in Gurgaon.
              </li>
              <li>Broader range including fresh produce in some setups.</li>
            </ul>

            <h3 className="font-medium text-gray-900">
              3. Hyper Mart (3001&ndash;8000 sq ft)
            </h3>
            <ul className="ml-4 list-inside list-disc space-y-2">
              <li>
            ...
            <p>
              ...
              be accessible. Typical ranges start from around &#8377;15 lakhs
              onwards (contact for exact personalized quote). Components
              include:
            </p>
            <ul className="ml-4 list-inside list-disc space-y-2">
            ...
            <ul className="ml-4 list-inside list-disc space-y-2">
              <li>Gross margins of 18&ndash;20%.</li>
            ...
            <ol className="ml-4 list-inside list-decimal space-y-2">
              <li>
                <strong>Inquiry &amp; Consultation</strong> &mdash; Site visit,
                feasibility study.
              </li>
              <li>
                <strong>Documentation</strong> &mdash; KYC, legal agreements,
                compliance (FSSAI, GST, MSME).
              </li>
              <li>
                <strong>Store Setup</strong> &mdash; Interior design, branding,
                POS installation, shelving.
              </li>
              <li>
                <strong>Supply Chain &amp; Inventory</strong> &mdash;
                Centralized sourcing, regular replenishment, localized
                assortment.
              </li>
              <li>
                <strong>Staff Training &amp; Operations</strong> &mdash; Full
                training, SOPs, CRM implementation.
              </li>
              <li>
                <strong>Marketing &amp; Launch</strong> &mdash; Grand opening
                campaigns, hyper-local digital marketing, WhatsApp/Instagram
                strategies, loyalty programs.
              </li>
              <li>
                <strong>Ongoing Support</strong> &mdash; Audits, performance
            ...
            <div className="mt-4 space-y-4">
              <div>
                ...
                <p className="mt-2 text-gray-700">
                  A1: Franchise Owned Company Managed &mdash; You own the store;
              ...
              <div>
                ...
                <p className="mt-2 text-gray-700">
                  A2: Starts from approximately &#8377;15 lakhs depending on
              ...
              <div>
                ...
                <p className="mt-2 text-gray-700">
                  A4: Gross margins around 18&ndash;20%, with strong potential
              ...
              <div>
                ...
                <p className="mt-2 text-gray-700">
                  A6: Yes, through Hassle-Free Inventory Assurance &mdash;
                  expired/damaged goods taken back.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="mt-2 text-gray-700">
                  A7: Typically 8&ndash;12 weeks from agreement to opening.
                </p>
              </div>
            </div>
