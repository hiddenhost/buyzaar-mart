...
export const metadata = {
  ...
  keywords: [
    ...
    "grocery store franchise Gurugram",
    "grocery store franchise in Gurugram",
    "Gurugram grocery store franchise",
    "The Buyzaar Mart Gurugram",
    "The Buyzaar Mart franchise",
    "grocery franchise Gurugram",
    "supermarket franchise Gurugram",
    "mini mart franchise Gurugram",
    "super mart franchise Gurugram",
    "retail franchise Gurugram",
    "organized retail franchise Gurugram",
    "FMCG franchise Gurugram",
    "daily needs franchise Gurugram",
    "convenience store franchise Gurugram",
    "neighborhood mart franchise Gurugram",
    "grocery chain franchise Gurugram",
    "branded grocery franchise Gurugram",
    "modern retail franchise Gurugram",
    "retail business opportunity Gurugram",
    "grocery business opportunity Gurugram",
    "low investment grocery franchise Gurugram",
    "profitable grocery franchise Gurugram",
    "best grocery franchise Gurugram",
    "small grocery franchise Gurugram",
    "daily essentials franchise Gurugram",
    "retail chain franchise Gurugram",
    "franchise grocery business Gurugram",
    "grocery shop franchise Gurugram",
    "grocery mart franchise Gurugram",
    "grocery outlet franchise Gurugram",
    "franchise business Gurugram",
    "grocery store investment Gurugram",
    "grocery retail franchise Gurugram",
    "grocery dealership Gurugram",
    "grocery franchise with zero royalty",
    "The Buyzaar Mart grocery franchise"
  ],
  alternates: {
    canonical:
